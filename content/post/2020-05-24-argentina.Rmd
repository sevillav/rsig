...
```{r echo=FALSE}
par(mfrow=c(1,1))
plot(puntos_sp$Arg_Prof_dsm, puntos_sp$AlturaZ, main="Relacion entre alturas modeladas por fotogrametria y alturas reales ", xlab="Altura modelada (MDE)", ylab='Altura reales de pts de control', pch= 16, col = "blue", text(15,0.5, "TEXT"), xlim=c(220, 240), ylim=c(220, 260))
abline(1, 1, col="red", lty=2)
#abline(0,1, lty=2, col='red')

abline(lm(puntos_sp$AlturaZ ~ puntos_sp$Arg_Prof_dsm), col = 'blue', lty=2)
legend(x = 221, y = 255,  legend = c("Relacion ideal 1:1", "Fotogrametria"), col = c("Red", "Blue"), 
       title = "Leyenda", lty = 2, cex = 0.75)
text(235,230,"AVE: 0.99", cex = 1.2)
```
